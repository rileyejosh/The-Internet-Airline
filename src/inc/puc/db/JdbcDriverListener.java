...
public class JdbcDriverListener implements ServletContextListener {
  ...
  /**
   * De-registers the JDBC drivers distributed with the application.
   */
  @Override
  ...
  public void contextInitialized(ServletContextEvent event) {
     Iterator driversIterator = (Iterator) ServiceLoader.load(Driver.class).iterator();
     while (((java.util.Iterator<Driver>) driversIterator).hasNext()) {
        try {
